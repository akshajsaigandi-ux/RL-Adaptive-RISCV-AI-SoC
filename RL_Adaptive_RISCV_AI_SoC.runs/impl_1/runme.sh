...
HD_PWD='C:/Users/aksha/Downloads/RL_Adaptive_RISCV_AI_SoC/RL_Adaptive_RISCV_AI_SoC/RL_Adaptive_RISCV_AI_SoC.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ras_fpga_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ras_fpga_top.tcl -notrace
