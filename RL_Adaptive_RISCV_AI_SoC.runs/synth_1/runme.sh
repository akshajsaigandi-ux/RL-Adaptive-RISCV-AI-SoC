...
HD_PWD='C:/Users/aksha/Downloads/RL_Adaptive_RISCV_AI_SoC/RL_Adaptive_RISCV_AI_SoC/RL_Adaptive_RISCV_AI_SoC.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ras_fpga_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ras_fpga_top.tcl
