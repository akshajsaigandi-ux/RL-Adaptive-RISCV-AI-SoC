...
REM
REM Generated by Vivado on Sat Aug 15 10:54:09 +0530 2026
...
echo "xvlog --incr --relax -L uvm -prj ras_adaptive_accelerator_tb_vlog.prj"
call xvlog  --incr --relax -L uvm -prj ras_adaptive_accelerator_tb_vlog.prj -log xvlog.log
